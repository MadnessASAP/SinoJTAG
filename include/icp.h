...
namespace cmd {
  inline constexpr uint8_t SET_IB_OFFSET_L = 0x40;
  inline constexpr uint8_t SET_IB_OFFSET_H = 0x41;
  inline constexpr uint8_t SET_IB_DATA     = 0x42;
  inline constexpr uint8_t GET_IB_OFFSET   = 0x43;
  inline constexpr uint8_t READ_FLASH      = 0x44;
  inline constexpr uint8_t SET_EXTENDED    = 0x46;
  inline constexpr uint8_t PING            = 0x49;
  inline constexpr uint8_t READ_CUSTOM     = 0x4A;
  inline constexpr uint8_t SET_XPAGE       = 0x4C;
}
